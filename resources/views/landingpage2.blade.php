...
<body class="index-page">
                    ...
                    <div class="modal-content">
                        <div class="receipt-header text-center py-3" style="background-color: #198754;">
                            <h5 class="modal-title" id="orderModalLabel" style="color: white">
                                <i class="bi bi-receipt-cutoff me-2"></i> GrainDryer Struk Pemesanan
                            </h5>
                        </div>
                        <div class="modal-body p-4">
                            <form action="{{ config('services.api.base_url') }}/pesanan" method="post"
    ...
    <footer id="footer" class="footer">
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">GrainDryer</strong> <span>Semua Hak
                    Dilindungi</span></p>
        </div>
    </footer>
