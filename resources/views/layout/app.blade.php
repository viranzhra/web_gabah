...
<head>
    ...
    <title>GrainDryer | Administrator</title>
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li
                            class="sidebar-item {{ request()->is('jenis_gabah') || request()->is('data_sensor') || request()->is('role_management') ? 'active' : '' }}">
                            <a class="sidebar-link" href="/jenis_gabah" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/validasi" aria-expanded="false">
                                ...
                                <span class="hide-menu">Validasi Dataset</span>
                            </a>
                        </li>
                        <li class="nav-small-cap" style="margin-left: -10px;">
                            <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                            <span class="hide-menu">GRAIN DRYER</span>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/prediksi" aria-expanded="false">
                                ...
                                <span class="hide-menu">Prediksi Pengeringan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
